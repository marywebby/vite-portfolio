...
const About = () => {
  return (
    ...
    <div>
      ...
      <p className='mb-4 leading-relaxed'>
        With a multidiciplinary education combining 
        <a href='https://education.msu.edu/kin/' className='no-underline text-teal-300 hover:text-teal-600' aria-label="MSU Kinesiology Homepage (opens in a new tab)" target="_blank" rel="noreferrer noopener" title="Kinesiology"> Kinesiology </a>
         and 
        ...
        , <a href='https://americorps.gov/serve/americorps/americorps-vista' className='no-underline text-teal-300 hover:text-teal-600' aria-label="Americorp VISTA Homepage (opens in a new tab)" target="_blank" rel="noreferrer noopener" title="AmeriCorps"> Non-profit Organizations</a>
        , and <a href='https://education.msu.edu/kin/' className='no-underline text-teal-300 hover:text-teal-600' aria-label="MSU Kinesiology Homepage (opens in a new tab)" target="_blank" rel="noreferrer noopener" title="Kinesiology"> Physical Education</a>
