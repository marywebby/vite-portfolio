...
const About = () => {
  return (
    <section id='about' className='mb-16 scroll-mt-16 md:mb-16 lg:mb-20 lg:scroll-mt-24 text-gray-500 text-md' aria-label='About me'>
